...
neither EDU3 nor SOSE were excluded (953 individuals.)
...
df_tmp5 <- df_tmp4 %>% 
  ...
  #select(contains("EDUC"), contains("SOSE"), "BR_DEC") %>% #summary()
  # ~700 still missing values removed
  filter(!is.na(EDUC3))
...
df.str %>% 
  ...
  summarise(sum_person_years = sum(FU_TIME))
